...
//
// ****************************************************************************
// https://github.com/Pajenicko/Picopad/blob/main/sdk/_lib/src/lib_drawtft.c
...
#define VAL50(a) (((a) >> 1) & ~(B4 |B10 |B15))
    ...
    switch (level) {
        ...
        case 0:
            ...
            // 6%
        case 1:
            return VAL50(col1) + VAL25(col1) + VAL12(col1) + VAL6(col1) + VAL6(col2);

            // 12%
        case 2:
            return VAL50(col1) + VAL25(col1) + VAL12(col1) + VAL12(col2);

            // 18%
        case 3:
            return VAL50(col1) + VAL25(col1) + VAL6(col1) + VAL12(col2) + VAL6(col2);

            // 25%
        case 4:
            return VAL50(col1) + VAL25(col1) + VAL25(col2);

            // 31%
        case 5:
            return VAL50(col1) + VAL12(col1) + VAL6(col1) + VAL25(col2) + VAL6(col2);

            // 37%
        case 6:
            return VAL50(col1) + VAL12(col1) + VAL25(col2) + VAL12(col2);

            // 44%
        case 7:
            return VAL50(col1) + VAL6(col1) + VAL25(col2) + VAL12(col2) + VAL6(col2);

            // 50%
        case 8:
            return VAL50(col1) + VAL50(col2);

            // 56%
        case 9:
            return VAL25(col1) + VAL12(col1) + VAL6(col1) + VAL50(col2) + VAL6(col2);

            // 62%
        case 10:
            return VAL25(col1) + VAL12(col1) + VAL50(col2) + VAL12(col2);

            // 69%
        case 11:
            return VAL25(col1) + VAL6(col1) + VAL50(col2) + VAL12(col2) + VAL6(col2);

            // 75%
        case 12:
            return VAL25(col1) + VAL50(col2) + VAL25(col2);

            // 81%
        case 13:
            return VAL12(col1) + VAL6(col1) + VAL50(col2) + VAL25(col2) + VAL6(col2);

            // 87%
        case 14:
            return VAL12(col1) + VAL50(col2) + VAL25(col2) + VAL12(col2);

            // 94%
        case 15:
            return VAL6(col1) + VAL50(col2) + VAL25(col2) + VAL12(col2) + VAL6(col2);
